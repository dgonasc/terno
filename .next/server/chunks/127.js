...
function Footer() {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: "fixed inset-x-0 bottom-0 flex items-center justify-between px-6 py-1 bg-gray-200 dark:bg-zinc-800",
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h3", {
                className: "ml-2 lg:text-sm font-xilosa dark:text-zinc-300 max-lg:text-xs",
