        ...
        >
            <div className="m-0 bg-white border-2 bg-opacity-90 dark:bg-slate-900 dark:border-t-black border-b-green-600 border-x-green-600 border-opacity-30 dark:border-opacity-20">
                <div className='flex flex-row items-center justify-between lg:px-14 xl:mr-24'>
                    ...
                    <nav ref={navRef} onClick={showNavBar} className="text-xl dark:text-zinc-300 max-lg:z-50 font-xilosa max-lg:text-5xl max-lg:-top-2 max-lg:bg-opacity-75 max-lg:mt-24 max-lg:absolute max-lg:hidden max-lg:justify-center max-lg:items-center max-lg:bg-green-500 dark:max-lg:bg-green-800 dark:max-lg:bg-opacity-30 max-lg:w-screen max-lg:h-screen lg:flex">
                        ...
                        <MotionConfig transition={{ duration: 1 }}>
                            <motion.div
                                ...
                                className="flex items-center space-x-3 text-2xl max-lg:bg-yellow-50 dark:max-lg:bg-yellow-600 max-lg:bg-opacity-70 max-lg:absolute max-lg:ml-6 max-lg:justify-center max-lg:mt-24 lg:justify-center drop-shadow-md max-lg:p-2 max-lg:border-2 max-lg:border-yellow-300 dark:dark:max-lg:border-yellow-400 max-lg:rounded-lg">
